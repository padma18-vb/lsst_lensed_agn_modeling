### Code used to compute NPE posteriors in Venkatraman et al 2025
...
class NetworkPredictions():
    ...
    def __init__(self,path_to_model_weights,path_to_model_norms=None,
                 ...
                 norm_type='norm', image_size=None, batch_size=None):
        """
        Args:
        ...
        if model_type == 'xresnet34':
            print('input num_outputs: ', num_outputs)
	        # print('params_as_inputs', params_as_inputs)
        ...
        # self.model.load_weights(model_weights,by_name=True,skip_mismatch=True)
    ...
    def gen_network_predictions(self,test_folder,samples=False,shuffle=False):
        ...
        return y_test, y_pred, std_pred, prec_pred, cov_pred
