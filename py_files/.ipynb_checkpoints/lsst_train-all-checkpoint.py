...
# for training
npy_folders_train = ['/pscratch/sd/v/vpadma/generated_images/train/0113/all/batch1/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0113/all/batch2/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0113/all/batch3/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0113/all/batch4/',
                    '/pscratch/sd/v/vpadma/generated_images/train/0113/all/batch5/']
...
npy_folder_val = ('/pscratch/sd/v/vpadma/generated_images/valid/0113/all/batch1/')
...
input_norm_path = os.path.join('/pscratch/sd/v/vpadma/full/0113/all', 'norms.csv')
...
model_weights = ('/pscratch/sd/v/vpadma/full/0113/all/_{epoch:02d}-{val_loss:.2f}.h5')
...
# csv path
csv_path = '/pscratch/sd/v/vpadma/full/0113/all/losses.csv'