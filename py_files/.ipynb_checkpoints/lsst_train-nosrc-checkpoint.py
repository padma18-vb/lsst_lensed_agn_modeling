...
# for training
npy_folders_train = ['/pscratch/sd/v/vpadma/generated_images/train/nosrc/batch1/',
                     '/pscratch/sd/v/vpadma/generated_images/train/nosrc/batch2/',
                     '/pscratch/sd/v/vpadma/generated_images/train/nosrc/batch3/',
                     '/pscratch/sd/v/vpadma/generated_images/train/nosrc/batch4/',
                    '/pscratch/sd/v/vpadma/generated_images/train/nosrc/batch5/']
...
npy_folder_val = ('/pscratch/sd/v/vpadma/generated_images/valid/nosrc/batch1/')
...
input_norm_path = os.path.join('/pscratch/sd/v/vpadma/diagonal/nosrc', 'norms.csv')
...
model_weights = ('/pscratch/sd/v/vpadma/diagonal/nosrc/_{epoch:02d}-{val_loss:.2f}.h5')
...
# csv path
csv_path = '/pscratch/sd/v/vpadma/diagonal/nosrc/losses.csv'