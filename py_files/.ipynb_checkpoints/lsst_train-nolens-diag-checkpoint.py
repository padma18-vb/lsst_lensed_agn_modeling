...
# for training
npy_folders_train = ['/pscratch/sd/v/vpadma/generated_images/train/0118/nolens/batch1/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0118/nolens/batch2/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0118/nolens/batch3/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0118/nolens/batch4/',
                    '/pscratch/sd/v/vpadma/generated_images/train/0118/nolens/batch5/']
...
npy_folder_val = ('/pscratch/sd/v/vpadma/generated_images/valid/0118/nolens/batch1/')
...
input_norm_path = os.path.join('/pscratch/sd/v/vpadma/diagonal/0118/nolens', 'norms.csv')
...
model_weights = ('/pscratch/sd/v/vpadma/diagonal/0118/nolens/_{epoch:02d}-{val_loss:.2f}.h5')
# The learning rate for the model
# learning_rate = starting_rate * (decay_rate ** (num_epochs * num_images_total) / (batch_size * steps_per_decay))
# learning_rate = 1e-4 * (0.98**(e5) / (1024 * 200))
learning_rate = 1e-4
...
# csv path
csv_path = '/pscratch/sd/v/vpadma/diagonal/0118/nolens/losses.csv'