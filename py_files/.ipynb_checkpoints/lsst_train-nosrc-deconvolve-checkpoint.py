...
# for training
npy_folders_train = ['/pscratch/sd/v/vpadma/generated_images/train/deconvolved/nosrc/batch1/',
                     '/pscratch/sd/v/vpadma/generated_images/train/deconvolved/nosrc/batch2/',
                     '/pscratch/sd/v/vpadma/generated_images/train/deconvolved/nosrc/batch3/',
                     '/pscratch/sd/v/vpadma/generated_images/train/deconvolved/nosrc/batch4/',
                    '/pscratch/sd/v/vpadma/generated_images/train/deconvolved/nosrc/batch5/']
...
npy_folder_val = ('/pscratch/sd/v/vpadma/generated_images/valid/deconvolved/nosrc/batch1/')
...
input_norm_path = os.path.join('/pscratch/sd/v/vpadma/full/deconvolved_nosrc', 'norms.csv')
...
model_weights = ('/pscratch/sd/v/vpadma/full/deconvolved_nosrc/_{epoch:02d}-{val_loss:.2f}.h5')
...
# csv path
csv_path = '/pscratch/sd/v/vpadma/full/deconvolved_nosrc/losses.csv'