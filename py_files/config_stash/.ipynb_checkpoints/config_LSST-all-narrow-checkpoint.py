...
config_dict = {
	'main_deflector':{
		...
		'parameters':{
			'z_lens': None,
			'gamma': truncnorm(-1.5,1.5,loc=2,scale=0.2).rvs,
			'theta_E': truncnorm(-0.55, 2,loc=0.8,scale=0.65).rvs,
			'e1':None,
			'e2':None,
			'center_x': None,
			'center_y': None,
			'gamma1': norm(loc=0, scale=0.04).rvs,
			'gamma2': norm(loc=0, scale=0.04).rvs,
			'ra_0':0.0, 'dec_0':0.0
		}
	},
	'lens_light':{
