...
# for training
npy_folders_train = ['/pscratch/sd/v/vpadma/generated_images/train/0118/deconvolved/nolens/batch1/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0118/deconvolved/nolens/batch2/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0118/deconvolved/nolens/batch3/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0118/deconvolved/nolens/batch4/',
                    '/pscratch/sd/v/vpadma/generated_images/train/0118/deconvolved/nolens/batch5/']
...
npy_folder_val = ('/pscratch/sd/v/vpadma/generated_images/valid/0118/deconvolved/nolens/batch1/')
...
input_norm_path = os.path.join('/pscratch/sd/v/vpadma/full/0118/deconvolved/nolens', 'norms.csv')
...
model_weights = ('/pscratch/sd/v/vpadma/full/0118/deconvolved/nolens/_{epoch:02d}-{val_loss:.2f}.h5')
...
learning_rate = 5e-5 # haven't trained with this loss yet; used to be 1e-4
...
# csv path
csv_path = '/pscratch/sd/v/vpadma/full/0118/deconvolved/nolens/losses.csv'