...
input_norm_path = os.path.join('/pscratch/sd/v/vpadma/diagonal/0118/all', 'norms.csv')
...
model_weights = ('/pscratch/sd/v/vpadma/diagonal/0118/all/_{epoch:02d}-{val_loss:.2f}.h5')
...
# csv path
csv_path = '/pscratch/sd/v/vpadma/diagonal/0118/all/losses.csv'