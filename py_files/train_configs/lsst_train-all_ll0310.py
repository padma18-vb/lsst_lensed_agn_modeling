...
learning_params = ['main_deflector_parameters_theta_E',
	...
	'main_deflector_parameters_center_y','lens_light_parameters_e1', 'lens_light_parameters_e2']
...
# for training
npy_folders_train = ['/pscratch/sd/v/vpadma/generated_images/train/0310/all/batch1/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0310/all/batch2/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0310/all/batch3/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0310/all/batch4/',
                    '/pscratch/sd/v/vpadma/generated_images/train/0310/all/batch5/']
...
npy_folder_val = ('/pscratch/sd/v/vpadma/generated_images/valid/0310/all/batch1/')
...
input_norm_path = os.path.join('/pscratch/sd/v/vpadma/full/0411/not_corr_learn_lens_light', 'norms.csv')
...
model_weights = ('/pscratch/sd/v/vpadma/full/0411/not_corr_learn_lens_light/_{epoch:02d}-{val_loss:.2f}.h5')
...
# csv path
csv_path = '/pscratch/sd/v/vpadma/full/0411/not_corr_learn_lens_light/losses.csv'