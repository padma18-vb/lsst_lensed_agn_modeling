...
# for training
npy_folders_train = ['/pscratch/sd/v/vpadma/generated_images/train/0118/deconvolved/all/batch1/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0118/deconvolved/all/batch2/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0118/deconvolved/all/batch3/',
                     '/pscratch/sd/v/vpadma/generated_images/train/0118/deconvolved/all/batch4/',
                    '/pscratch/sd/v/vpadma/generated_images/train/0118/deconvolved/all/batch5/']
...
npy_folder_val = ('/pscratch/sd/v/vpadma/generated_images/valid/0118/deconvolved/all/batch1/')
...
input_norm_path = os.path.join('/pscratch/sd/v/vpadma/full/0118/deconvolved/all', 'norms.csv')
...
model_weights = ('/pscratch/sd/v/vpadma/full/0118/0118/deconvolved/all/_{epoch:02d}-{val_loss:.2f}.h5')
...
# csv path
csv_path = '/pscratch/sd/v/vpadma/full/0118/deconvolved/all/losses.csv'