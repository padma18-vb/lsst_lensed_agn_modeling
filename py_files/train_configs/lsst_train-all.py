...
input_norm_path = os.path.join('/pscratch/sd/v/vpadma/full/0411/all', 'norms.csv')
...
model_weights = ('/pscratch/sd/v/vpadma/full/0411/all/_{epoch:02d}-{val_loss:.2f}.h5')
...
# csv path
csv_path = '/pscratch/sd/v/vpadma/full/0411/all/losses.csv'