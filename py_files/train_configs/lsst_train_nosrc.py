...
# for training
npy_folders_train = ['/pscratch/sd/v/vpadma/generated_images/train/nosrc_batch1/',
                     '/pscratch/sd/v/vpadma/generated_images/train/nosrc_batch2/',
                     '/pscratch/sd/v/vpadma/generated_images/train/nosrc_batch3/',
                     '/pscratch/sd/v/vpadma/generated_images/train/nosrc_batch4/',
                    '/pscratch/sd/v/vpadma/generated_images/train/nosrc_batch5/']
...
npy_folder_val = ('/pscratch/sd/v/vpadma/generated_images/valid/nosrc_batch1/')
...
input_norm_path = os.path.join('/pscratch/sd/v/vpadma/full/nosrc_results', 'norms.csv')
...
model_weights = ('/pscratch/sd/v/vpadma/full/nosrc_results/_{epoch:02d}-{val_loss:.2f}.h5')
...
# csv path
csv_path = '/pscratch/sd/v/vpadma/full/nosrc_results/losses.csv'